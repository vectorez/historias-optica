	...
	*/
	class ModeloHistorias
	{
		...
		static public function mdlIngresarHistorias($tabla, $datos){
			...
			$stmt->bindParam(":historias_con_vp_od_i", 						$datos['historias_con_vp_od_i'], PDO::PARAM_STR);
			$stmt->bindParam(":historias_sin_vp_od_i", 						$datos['historias_sin_vp_od_i'], PDO::PARAM_STR);
			$stmt->bindParam(":historias_con_vp_id_i", 						$datos['historias_con_vp_id_i'], PDO::PARAM_STR);
			$stmt->bindParam(":historias_sin_vp_id_i", 						$datos['historias_sin_vp_id_i'], PDO::PARAM_STR);
		...
		static public function mdlIngresarDatosExtrasHistorias($tabla , $datos){
			$pdo = Conexion::conectar();
			$stmt = $pdo->prepare("INSERT INTO $tabla (auxiliares_historia_id_i, auxiliares_esfera_v, auxiliares_cilindro_v, auxiliares_eje_v, auxiliares_add_v, auxiliares_av_v, auxiliares_dp_v, auxiliares_tipo_pregunta_v, auxiliares_od_id_v, auxiliares_auv_v , auxiliares_avvl_v, auxiliares_avvp_v, auxiliares_altura_foral_v) VALUES (:auxiliares_historia_id_i, :auxiliares_esfera_v, :auxiliares_cilindro_v, :auxiliares_eje_v, :auxiliares_add_v, :auxiliares_av_v, :auxiliares_dp_v, :auxiliares_tipo_pregunta_v, :auxiliares_od_id_v, :auxiliares_auv_v, :auxiliares_avvl_v, :auxiliares_avvp_v, :auxiliares_altura_foral_v)");
			...
			$stmt -> bindParam(":auxiliares_avvl_v", 			$datos['auxiliares_avvl_v'], 			PDO::PARAM_STR);
			$stmt -> bindParam(":auxiliares_avvp_v", 			$datos['auxiliares_avvp_v'], 			PDO::PARAM_STR);
			$stmt -> bindParam(":auxiliares_altura_foral_v", 	$datos['auxiliares_altura_foral_v'], 	PDO::PARAM_STR);
		...
		static public function mdlActualizaDatosExtrasHistorias($tabla , $datos){
			$pdo = Conexion::conectar();
			$stmt = $pdo->prepare("UPDATE $tabla SET auxiliares_esfera_v = :auxiliares_esfera_v, auxiliares_cilindro_v = :auxiliares_cilindro_v, auxiliares_eje_v = :auxiliares_eje_v, auxiliares_add_v = :auxiliares_add_v, auxiliares_av_v = :auxiliares_av_v, auxiliares_dp_v = :auxiliares_dp_v, auxiliares_tipo_pregunta_v = :auxiliares_tipo_pregunta_v, auxiliares_od_id_v = :auxiliares_od_id_v, auxiliares_auv_v = :auxiliares_auv_v, auxiliares_altura_foral_v = :auxiliares_altura_foral_v, auxiliares_avvl_v = :auxiliares_avvl_v, auxiliares_avvp_v = :auxiliares_avvp_v WHERE auxiliares_historia_id_i = :auxiliares_historia_id_i AND auxiliares_id_i = :auxiliares_id_i");
